...
* :earth\_americas: [Mach-O file format reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference) ⭐ 884 | 🐛 2 | 📅 2024-10-13
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,385 | 🐛 88 | 🌐 Python | 📅 2026-09-14 - Project created to make the possibility of malware analysis open and available to the public.
* [Malware Archive](https://github.com/jstrosch/malware-samples) ⭐ 1,682 | 🐛 1 | 🌐 HTML | 📅 2024-01-13 - Malware samples, analysis exercises and other interesting resources.
...
* [PePacker](https://github.com/SamLarenN/PePacker) ⭐ 49 | 🐛 1 | 🌐 C++ | 📅 2017-05-28 - Simple PE Packer Which Encrypts .text Section I release a simple PE file packer which encrypts the .text section and adds a decryption stub to the end of the last section.
...
* [Eronona-Packer](https://github.com/Eronana/packer) ⭐ 47 | 🐛 0 | 🌐 C++ | 📅 2020-02-19 - This is a packer for exe under win32.
...
* [LZPACK](https://github.com/johnsonjh/lzpack) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-09-15 - LZPACK - PopCom!-compatible CP/M-80 executable compressor in ANSI C, runs on 48K CP/M-80, CP/M-86, MS-DOS, UNIX, and other platforms.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,092 | 🐛 732 | 🌐 Python | 📅 2026-09-16 - Platform-agnostic binary analysis framework.
* [RetDec](https://github.com/avast/retdec) ⭐ 8,629 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - Retargetable machine-code decompiler based on LLVM.
...
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,564 | 🐛 32 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,295 | 🐛 38 | 🌐 C++ | 📅 2026-09-16 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,267 | 🐛 13 | 🌐 C++ | 📅 2026-09-11 - Detect It Easy ; Program for determining types of files.
...
* [APKiD](https://github.com/rednaga/APKiD) ⭐ 2,575 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
...
* [IDR](https://github.com/crypto2011/IDR) ⭐ 1,158 | 🐛 43 | 🌐 C++ | 📅 2023-08-09 - Interactive Delphi Reconstructor.
...
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 878 | 🐛 16 | 🌐 Python | 📅 2026-09-16 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
* [MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 841 | 🐛 1 | 🌐 C | 📅 2026-04-14 - Dynamic unpacker based on PE-sieve.
* [PEPack](https://github.com/mentebinaria/readpe) ⭐ 786 | 🐛 14 | 🌐 C | 📅 2026-08-25 - PE file packer detection tool, part of the Unix package "pev".
...
* [SecML Malware](https://github.com/pralab/secml_malware) ⭐ 250 | 🐛 13 | 🌐 Python | 📅 2025-11-27 - Create adversarial attacks against machine learning Windows malware detectors.
