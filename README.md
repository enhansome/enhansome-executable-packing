...
* :earth\_americas: [Awesome executable packing](https://github.com/packing-box/awesome-executable-packing) ⭐ 1,619 | 🐛 1 | 📅 2026-05-31
* :earth\_americas: [Mach-O file format reference](https://github.com/aidansteele/osx-abi-macho-file-format-reference) ⭐ 883 | 🐛 2 | 📅 2024-10-13
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,396 | 🐛 89 | 🌐 Python | 📅 2026-09-14 - Project created to make the possibility of malware analysis open and available to the public.
...
* [Ember2024](https://github.com/futurecomputing4ai/ember2024) ⭐ 154 | 🐛 14 | 🌐 Python | 📅 2025-08-22 - Update to the EMBER2017 and EMBER2018 datasets.
...
* [Crinkler](https://github.com/runestubbe/Crinkler) ⭐ 1,290 | 🐛 6 | 🌐 C++ | 📅 2026-08-05 - Compressing linker for Windows, specifically targeted towards executables with a size of just a few kilobytes.
...
* [Pakkero](https://github.com/89luca89/pakkero) ⭐ 277 | 🐛 3 | 🌐 Go | 📅 2023-01-16 - Binary packer written in Go made for fun and educational purpose.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,099 | 🐛 720 | 🌐 Python | 📅 2026-09-18 - Platform-agnostic binary analysis framework.
* [RetDec](https://github.com/avast/retdec) ⭐ 8,631 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - Retargetable machine-code decompiler based on LLVM.
* [de4dot](https://github.com/0xd4d/de4dot) ⚠️ Archived - .NET deobfuscator and unpacker.
* [Capa](https://github.com/mandiant/capa) ⭐ 6,189 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,565 | 🐛 33 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,298 | 🐛 36 | 🌐 C++ | 📅 2026-09-18 - Dynamic binary analysis library.
...
* [PANDA](https://github.com/panda-re/panda) ⭐ 2,781 | 🐛 97 | 🌐 C | 📅 2026-09-17 - Platform for Architecture-Neutral Dynamic Analysis.
* [Reko](https://github.com/uxmal/reko) ⭐ 2,604 | 🐛 165 | 🌐 C# | 📅 2026-09-11 - Free decompiler for machine code binaries.
* [APKiD](https://github.com/rednaga/APKiD) ⭐ 2,576 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
* [Pefile](https://github.com/erocarrera/pefile) ⭐ 2,068 | 🐛 61 | 🌐 Python | 📅 2026-09-18 - Multi-platform Python module to parse and work with Portable Executable files.
...
* [Android Unpacker](https://github.com/strazzere/android-unpacker) ⭐ 1,177 | 🐛 0 | 🌐 C | 📅 2020-01-20 - Presented at Defcon 22: Android Hacker Protection Level 0.
...
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 878 | 🐛 16 | 🌐 Python | 📅 2026-09-18 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
* [MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 843 | 🐛 1 | 🌐 C | 📅 2026-04-14 - Dynamic unpacker based on PE-sieve.
...
* [PE-bear](https://github.com/hasherezade/pe-bear-releases) ⭐ 777 | 🐛 9 | 📅 2023-06-04 - Freeware reversing tool for PE files aimed to deliver fast and flexible “first view” for malware analysts, stable and capable to handle malformed PE files.
* [Unipacker](https://github.com/unipacker/unipacker) ⭐ 776 | 🐛 28 | 🌐 Python | 📅 2025-08-18 - Automatic and platform-independent unpacker for Windows binaries based on emulation.
...
* [ShowStopper](https://github.com/CheckPointSW/showstopper) ⭐ 225 | 🐛 1 | 🌐 C++ | 📅 2026-03-31 - Tool to help malware researchers explore and test anti-debug techniques or verify debugger plugins or other solutions that clash with standard anti-debug methods.
...
* [Packing-Box](https://github.com/dhondta/docker-packing-box) ⭐ 67 | 🐛 12 | 🌐 Python | 📅 2026-08-19 - Docker image gathering many packing-related tools and for making datasets of packed executables for use with machine learning.
