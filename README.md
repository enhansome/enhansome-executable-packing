...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,347 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - Project created to make the possibility of malware analysis open and available to the public.
...
* [Ember2024](https://github.com/futurecomputing4ai/ember2024) ⭐ 147 | 🐛 14 | 🌐 Python | 📅 2025-08-22 - Update to the EMBER2017 and EMBER2018 datasets.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,056 | 🐛 701 | 🌐 Python | 📅 2026-09-02 - Platform-agnostic binary analysis framework.
...
* [Capa](https://github.com/mandiant/capa) ⭐ 6,164 | 🐛 298 | 🌐 Python | 📅 2026-09-01 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,555 | 🐛 30 | 🌐 C++ | 📅 2026-08-30 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,280 | 🐛 40 | 🌐 C++ | 📅 2026-08-31 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,248 | 🐛 15 | 🌐 C++ | 📅 2026-09-02 - Detect It Easy ; Program for determining types of files.
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,145 | 🐛 6 | 🌐 YARA | 📅 2026-08-29 - Robust parser for PE files with a flexible plugin architecture which allows users to statically analyze files in-depth.
* [EXEInfo-PE](https://github.com/ExeinfoASL/ASL) ⭐ 1,144 | 🐛 8 | 📅 2026-08-08 - Fast detector for executable PE files.
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 873 | 🐛 16 | 🌐 Python | 📅 2026-09-02 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
