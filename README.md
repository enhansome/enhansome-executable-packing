...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,406 | 🐛 90 | 🌐 Python | 📅 2026-09-14 - Project created to make the possibility of malware analysis open and available to the public.
...
* [ASM Guard](https://github.com/DosX-dev/ASM-Guard) ⭐ 271 | 🐛 0 | 📅 2024-02-20 - Packer utility for compressing and complicating reversing compiled native code (native files), protecting resources, adding DRM, and packing into an optimized loader.
* [MidgetPack](https://github.com/arisada/midgetpack) ⭐ 209 | 🐛 6 | 🌐 C | 📅 2014-07-29 - ELF binary packer, such as burneye, upx or other tools.
* [TinyLoad](https://github.com/iamsopotatoe-coder/TinyLoad) ⭐ 190 | 🐛 2 | 🌐 C++ | 📅 2026-08-31 - Simple PE packer for Windows that compresses and encrypts executables with a custom virtual machine into a self-extracting stub.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,107 | 🐛 725 | 🌐 Python | 📅 2026-09-24 - Platform-agnostic binary analysis framework.
...
* [Capa](https://github.com/mandiant/capa) ⭐ 6,199 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,571 | 🐛 36 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,308 | 🐛 36 | 🌐 C++ | 📅 2026-09-18 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,272 | 🐛 15 | 🌐 C++ | 📅 2026-09-23 - Detect It Easy ; Program for determining types of files.
* [PANDA](https://github.com/panda-re/panda) ⭐ 2,782 | 🐛 97 | 🌐 C | 📅 2026-09-24 - Platform for Architecture-Neutral Dynamic Analysis.
* [Reko](https://github.com/uxmal/reko) ⭐ 2,606 | 🐛 165 | 🌐 C# | 📅 2026-09-11 - Free decompiler for machine code binaries.
...
* [IDR](https://github.com/crypto2011/IDR) ⭐ 1,161 | 🐛 43 | 🌐 C++ | 📅 2023-08-09 - Interactive Delphi Reconstructor.
...
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 884 | 🐛 16 | 🌐 Python | 📅 2026-09-24 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
