...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,398 | 🐛 89 | 🌐 Python | 📅 2026-09-14 - Project created to make the possibility of malware analysis open and available to the public.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,099 | 🐛 721 | 🌐 Python | 📅 2026-09-19 - Platform-agnostic binary analysis framework.
...
* [Capa](https://github.com/mandiant/capa) ⭐ 6,193 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,566 | 🐛 33 | 🌐 C++ | 📅 2026-09-06 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,300 | 🐛 36 | 🌐 C++ | 📅 2026-09-18 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,266 | 🐛 14 | 🌐 C++ | 📅 2026-09-19 - Detect It Easy ; Program for determining types of files.
...
* [APKiD](https://github.com/rednaga/APKiD) ⭐ 2,577 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
...
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 878 | 🐛 16 | 🌐 Python | 📅 2026-09-19 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
...
* [Unipacker](https://github.com/unipacker/unipacker) ⭐ 777 | 🐛 28 | 🌐 Python | 📅 2025-08-18 - Automatic and platform-independent unpacker for Windows binaries based on emulation.
...
* [SecML Malware](https://github.com/pralab/secml_malware) ⭐ 251 | 🐛 13 | 🌐 Python | 📅 2025-11-27 - Create adversarial attacks against machine learning Windows malware detectors.
