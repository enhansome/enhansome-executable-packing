...
* :earth\_americas: [Awesome LLVM security](https://github.com/gmh5225/awesome-llvm-security) ⭐ 871 | 🐛 0 | 📅 2026-08-05
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,292 | 🐛 89 | 🌐 Python | 📅 2026-07-24 - Project created to make the possibility of malware analysis open and available to the public.
...
* [Ember2024](https://github.com/futurecomputing4ai/ember2024) ⭐ 134 | 🐛 14 | 🌐 Python | 📅 2025-08-22 - Update to the EMBER2017 and EMBER2018 datasets.
...
* [TinyLoad](https://github.com/iamsopotatoe-coder/TinyLoad) ⭐ 184 | 🐛 1 | 🌐 C++ | 📅 2026-08-11 - Simple PE packer for Windows that compresses and encrypts executables with a custom virtual machine into a self-extracting stub.
...
* [Angr](https://github.com/angr/angr) ⭐ 9,009 | 🐛 699 | 🌐 Python | 📅 2026-08-13 - Platform-agnostic binary analysis framework.
* [RetDec](https://github.com/avast/retdec) ⭐ 8,604 | 🐛 458 | 🌐 C++ | 📅 2026-05-26 - Retargetable machine-code decompiler based on LLVM.
* [de4dot](https://github.com/0xd4d/de4dot) ⚠️ Archived - .NET deobfuscator and unpacker.
* [Capa](https://github.com/mandiant/capa) ⭐ 6,133 | 🐛 287 | 🌐 Python | 📅 2026-08-13 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
* [LIEF](https://github.com/lief-project/LIEF) ⭐ 5,524 | 🐛 32 | 🌐 C++ | 📅 2026-08-07 - Library to Instrument Executable Formats ; Python package for parsing PE, ELF, Mach-O and DEX formats, modifying and rebuilding executables.
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,260 | 🐛 38 | 🌐 C++ | 📅 2026-07-28 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,220 | 🐛 13 | 🌐 C++ | 📅 2026-08-13 - Detect It Easy ; Program for determining types of files.
* [PANDA](https://github.com/panda-re/panda) ⭐ 2,773 | 🐛 96 | 🌐 C | 📅 2026-07-29 - Platform for Architecture-Neutral Dynamic Analysis.
* [Reko](https://github.com/uxmal/reko) ⭐ 2,599 | 🐛 165 | 🌐 C# | 📅 2026-08-12 - Free decompiler for machine code binaries.
* [APKiD](https://github.com/rednaga/APKiD) ⭐ 2,553 | 🐛 84 | 🌐 YARA | 📅 2026-07-27 - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
* [Pefile](https://github.com/erocarrera/pefile) ⭐ 2,062 | 🐛 66 | 🌐 Python | 📅 2026-08-12 - Multi-platform Python module to parse and work with Portable Executable files.
* [yarGen](https://github.com/Neo23x0/yarGen) ⭐ 1,807 | 🐛 14 | 🌐 Python | 📅 2026-01-10 - Generator for YARA rules - The main principle is the creation of yara rules from strings found in malware files while removing all strings that also appear in goodware files.
* [de4js](https://github.com/lelinhtinh/de4js) ⚠️ Archived - JavaScript Deobfuscator and Unpacker.
* [.NET Deobfuscator](https://github.com/NotPrab/.NET-Deobfuscator) ⭐ 1,510 | 🐛 1 | 📅 2025-02-01 - List of .NET Deobfuscators and Unpackers.
* [PETools](https://github.com/petoolse/petools) ⭐ 1,193 | 🐛 10 | 📅 2025-10-21 - Old-school reverse engineering tool (with a long history since 2002) for manipulating PE files.
...
* [IDR](https://github.com/crypto2011/IDR) ⭐ 1,152 | 🐛 42 | 🌐 C++ | 📅 2023-08-09 - Interactive Delphi Reconstructor.
* [EXEInfo-PE](https://github.com/ExeinfoASL/ASL) ⭐ 1,132 | 🐛 8 | 📅 2026-08-08 - Fast detector for executable PE files.
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,132 | 🐛 6 | 🌐 YARA | 📅 2026-08-12 - Robust parser for PE files with a flexible plugin architecture which allows users to statically analyze files in-depth.
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 862 | 🐛 16 | 🌐 Python | 📅 2026-08-13 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
* [MalUnpack](https://github.com/hasherezade/mal_unpack) ⭐ 833 | 🐛 1 | 🌐 C | 📅 2026-04-14 - Dynamic unpacker based on PE-sieve.
* [PEPack](https://github.com/mentebinaria/readpe) ⭐ 780 | 🐛 14 | 🌐 C | 📅 2026-07-08 - PE file packer detection tool, part of the Unix package "pev".
...
* [Malheur](https://github.com/rieck/malheur) ⭐ 377 | 🐛 1 | 🌐 C | 📅 2019-05-08 - Tool for the automatic analysis of malware behavior (recorded from malicious software in a sandbox environment).
...
* [Packing-Box](https://github.com/dhondta/docker-packing-box) ⭐ 66 | 🐛 14 | 🌐 Python | 📅 2026-07-04 - Docker image gathering many packing-related tools and for making datasets of packed executables for use with machine learning.
