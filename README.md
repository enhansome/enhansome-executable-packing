...
* :earth\_americas: [Awesome executable packing](https://github.com/packing-box/awesome-executable-packing) ⭐ 1,623 | 🐛 1 | 📅 2026-05-31
...
* [theZoo](https://github.com/ytisf/theZoo) ⭐ 13,404 | 🐛 90 | 🌐 Python | 📅 2026-09-14 - Project created to make the possibility of malware analysis open and available to the public.
...
* [Crinkler](https://github.com/runestubbe/Crinkler) ⭐ 1,291 | 🐛 6 | 🌐 C++ | 📅 2026-08-05 - Compressing linker for Windows, specifically targeted towards executables with a size of just a few kilobytes.
...
* [Hyperion](https://github.com/nullsecuritynet/tools/tree/main/binary/hyperion) ⭐ 70 | 🐛 2 | 🌐 Python | 📅 2026-08-03
...
* [Capa](https://github.com/mandiant/capa) ⭐ 6,196 | 🐛 307 | 🌐 Python | 📅 2026-09-14 - Open-source tool to identify capabilities in PE, ELF or .NET executable files.
...
* [Triton](https://github.com/jonathansalwan/Triton) ⭐ 4,305 | 🐛 36 | 🌐 C++ | 📅 2026-09-18 - Dynamic binary analysis library.
* [DIE](https://github.com/horsicq/DIE-engine/releases) ⭐ 3,271 | 🐛 14 | 🌐 C++ | 📅 2026-09-23 - Detect It Easy ; Program for determining types of files.
* [PANDA](https://github.com/panda-re/panda) ⭐ 2,782 | 🐛 97 | 🌐 C | 📅 2026-09-23 - Platform for Architecture-Neutral Dynamic Analysis.
* [Reko](https://github.com/uxmal/reko) ⭐ 2,604 | 🐛 165 | 🌐 C# | 📅 2026-09-11 - Free decompiler for machine code binaries.
* [APKiD](https://github.com/rednaga/APKiD) ⭐ 2,579 | 🐛 84 | 🌐 YARA | 📅 2026-09-02 - Android application Identifier for packers, protectors, obfuscators and oddities - PEiD for Android.
...
* [.NET Deobfuscator](https://github.com/NotPrab/.NET-Deobfuscator) ⭐ 1,517 | 🐛 1 | 📅 2025-02-01 - List of .NET Deobfuscators and Unpackers.
...
* [Winbindex](https://github.com/m417z/winbindex) ⭐ 882 | 🐛 16 | 🌐 Python | 📅 2026-09-23 - An index of Windows binaries, including download links for executables such as EXE, DLL and SYS files.
